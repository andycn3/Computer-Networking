...
public class DNSLookupServiceTest {
    ...
    private void processResponseCommonTest(boolean authoritative, int errorCode,
                                           ...
                                           Collection<ResourceRecord> additional) throws DNSLookupService.DNSErrorException, DNSLookupService.DNSReplyTruncatedException {
    ...
    @Test
    public void testProcessResponseSingleAnswer() throws UnknownHostException, DNSLookupService.DNSErrorException, DNSLookupService.DNSReplyTruncatedException {
